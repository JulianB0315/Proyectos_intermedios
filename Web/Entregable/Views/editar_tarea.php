<?php if (isset($tarea)): ?>
    ...
    <body>
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="task-card">
                <h1>Editar Tarea</h1>
                <form action="/Entregable/?action=actualizar_tarea" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="fecha_limite" name="fecha_limite" class="form-control" value="<?= htmlspecialchars($tarea['fecha_limite']) ?>" required>
                    </div>
...
<?php else: ?>
    <p>No se encontraron datos de la tarea.</p>
<?php endif; ?>